...
urlpatterns = [
    ...
    re_path(r'^(\d+)/json$', views.json_list, name='json_list'),
    re_path(r'^(\d+)/(\d+)/delete$', views.delete_item, name='delete_item'),
    re_path(r'^(\d+)/delete$', views.delete_list, name='delete_list'),
